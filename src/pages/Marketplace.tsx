    ...
    <div className="responsive-grid">
      ...
      <div className="card"><div className="card-header"><span className="card-title">Publish your model</span></div>
        <div className="card-body">
          ...
          <div className="form-group"><label className="form-label">Price per Inference (SBY)</label><input className="form-input" type="number" step="0.01" value={price} onChange={e=>setPrice(e.target.value)} /></div>
